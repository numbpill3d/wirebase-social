  ...
  if (transactionFilter) {
    transactionFilter.addEventListener('change', function() {
      ...
      if (type === 'all') {
        ...
        transactionItems.forEach(item => {
          // Handle conversion types which can be either loot_to_wir_conversion or wir_to_loot_conversion
          if (type === 'conversion' &&
              (item.classList.contains('type-loot_to_wir_conversion') ||
               item.classList.contains('type-wir_to_loot_conversion'))) {
            item.style.display = 'flex';
          } else if (item.classList.contains(`type-${type}`)) {
            item.style.display = 'flex';
          } else {
