...
class User {
  ...
  static async create(userData) {
    try {
      ...
      const user = {
        ...
        avatar: userData.avatar || '/images/laincore/default-avatar.png',
        custom_glyph: userData.customGlyph || '👁️',
        status_message: userData.statusMessage || 'Just connected to wirebase.city',
        status_icon: userData.statusIcon || 'online',
        loot_tokens: userData.lootTokens || 10,
        wir_balance: userData.wirBalance || 100, // Default starting WIR balance
        wir_transactions: userData.wirTransactions || [],
        collections: userData.collections || [],
        wishlist_id: userData.wishlistId || null,
        selling_items: userData.sellingItems || [],
  ...
  async save() {
    try {
      ...
      const userData = {
        ...
        wir_balance: this.wirBalance,
        wir_transactions: this.wirTransactions,
        collections: this.collections,
        wishlist_id: this.wishlistId,
        selling_items: this.sellingItems,
  ...
  static formatUser(dbUser) {
    ...
    return {
      ...
      wirBalance: dbUser.wir_balance || 0,
      wirTransactions: dbUser.wir_transactions || [],
      collections: dbUser.collections || [],
      wishlistId: dbUser.wishlist_id,
      sellingItems: dbUser.selling_items || [],
      purchasedItems: dbUser.purchased_items || [],
