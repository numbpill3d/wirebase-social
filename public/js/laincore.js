...
function createGlitchEffect() {
  ...
  if (prefersReducedMotion) {
    return; // Skip glitch effect for users who prefer reduced motion
  }

  // Create a glitch overlay with reduced intensity
  ...
  glitch.style.backgroundColor = 'rgba(255, 0, 0, 0.05)'; // Reduced opacity

  // Add to body
  document.body.appendChild(glitch);

  // Random horizontal offset (reduced)
  const offsetX = Math.random() * 4 - 2; // -2 to 2px (less movement)
