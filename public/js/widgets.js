...
function initStatsWidget() {
  ...
  const loadingState = window.loadingStates.get(statsWidget);
  if (loadingState) {
    loadingState.start();
...
function initTrafficWidget() {
  ...
  const loadingState = window.loadingStates.get(trafficWidget);
  if (loadingState) {
    loadingState.start();
...
function initActivityWidget() {
  ...
  const loadingState = window.loadingStates.get(activityWidget);
  if (loadingState) {
    loadingState.start();
...
function initMoodWidget() {
  ...
  const loadingState = window.loadingStates.get(moodWidget);
  if (loadingState) {
    loadingState.start();
